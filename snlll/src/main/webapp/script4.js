const boardSize = 10; // Number of tiles in one row/column
    ...
    const playerCoins = { 1: document.getElementById('coin1'), 2: document.getElementById('coin2'), 3: document.getElementById('coin3'), 4: document.getElementById('coin4') };
    const playerPositions = { 1: 1, 2: 1, 3: 1, 4: 1 }; // Start positions are 1
    ...
    const player4 = document.getElementById('player4RollBtn');
    ...
    player4.addEventListener('click', () => rollDice(4));
    ...
    document.getElementById('startGameBtn').addEventListener('click', () => {
        ...
        moveCoin(4, 1); // Reset player 4 position
